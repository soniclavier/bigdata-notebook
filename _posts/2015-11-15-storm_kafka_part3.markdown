...
This is the last part of the blog *Realtime Processing using Storm and Kafka*. You can find the previous parts here - [Part1]({% post_url 2015-11-15-storm_kafka_part1%}), [Part2]({% post_url 2015-11-15-storm_kafka_part2%}). In this section we will develop the Kafka Spout, Storm Topology and execute the project.
